<div class="cbw-select-plugins">
	<div class="cbw-block">
		...
		<div class="cbw-block__top">
			<p><?php
				_e( 'The required set of basic plugins which are necessary for the landing page to work smoothly. If you don’t install one or more plugins from this list, the specific sections of this landing page, that are displayed with this plugin’s functionality, will be missing. ', 'croco-ik' );
