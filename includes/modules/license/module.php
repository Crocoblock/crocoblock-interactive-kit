...
use Croco_IK\Tools\Files_Download as Files_Download;
...
class Module extends Module_Base {
	...
	public function enqueue_module_assets() {
		...
		wp_enqueue_script(
			'croco-ik-license',
			CROCO_IK_URL . 'assets/js/license.js',
			array( 'cx-vue-ui' ),
			CROCO_IK_VERSION,
			true
		);
	...
	public function page_config( $config = array(), $subpage = '' ) {
		...
		$config['next_step']          = Plugin::instance()->dashboard->page_url( 'install-plugins' );
