...
class Extensions {
	...
	public function __construct() {
		...
		add_action( 'croco-ik/after-plugin-activation', array( $this, 'prevent_bp_redirect' ) );
		add_action( 'croco-ik/after-plugin-activation', array( $this, 'prevent_elementor_redirect' ) );
		add_action( 'croco-ik/after-plugin-activation', array( $this, 'prevent_bbp_redirect' ) );
		add_action( 'croco-ik/after-plugin-activation', array( $this, 'prevent_booked_redirect' ) );
		add_action( 'croco-ik/after-plugin-activation', array( $this, 'prevent_tribe_redirect' ) );
		add_action( 'croco-ik/after-plugin-activation', array( $this, 'prevent_woo_redirect' ) );
		add_action( 'croco-ik/install-finished', array( $this, 'ensure_prevent_booked_redirect' ) );
	...
	public function add_dashboard_plugins_section( $builder, $dashboard ) {
		...
		$builder->register_section(
			array(
				'croco-ik' => array(
					'title' => esc_html__( 'Recommended plugins', 'croco-ik' ),
					'class' => 'tm-dashboard-section tm-dashboard-section--croco-ik',
